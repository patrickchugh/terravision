...
6. [Available Transformers](#available-transformers)
   - [Resource Expansion](#resource-expansion-2-transformers)
   - [Resource Grouping](#resource-grouping-4-transformers)
   - [Connections](#connections-11-transformers)
   - [Graph Manipulation](#graph-manipulation-1-transformer)
   - [Metadata Operations](#metadata-operations-1-transformer)
   - [Cleanup](#cleanup-1-transformer)
   - [Variants](#variants-2-transformers)
   - [Pipeline](#pipeline-1-orchestrator)
